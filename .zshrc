...
export ZSH="/Users/aidanhobler/.oh-my-zsh"
...
__conda_setup="$('/Users/aidanhobler/opt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/aidanhobler/opt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/aidanhobler/opt/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/aidanhobler/opt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# Make it so I can CD upon exit with Q or exit normally with q
function ranger {
    local IFS=$'\t\n'
